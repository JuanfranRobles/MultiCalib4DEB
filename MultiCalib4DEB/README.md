...
The result is in the next ![image](/examples/statistical_analysis_example.png), where the fields of the statistical analysis results and its values are shown. 
